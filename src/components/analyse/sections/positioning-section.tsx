    ...
    <section className="bg-surface py-20 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="font-heading text-primary text-[38px] leading-[1.05] md:text-[60px] mb-6">
          ...
          <span className="text-body">You Bring the Driver.</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-primary/10">
          <div className="bg-surface p-8">
            ...
            <ul className="space-y-2 text-body text-sm">
              {['Core Web Vitals & speed', 'Plugin stack optimalisatie', 'Tech stack architectuur', 'Tracking & data infrastructure', 'Headless / Hydrogen migratie'].map(item => (
          ...
          <div className="bg-[#f9f9f9] p-8">
            ...
            <ul className="space-y-2 text-body text-sm">
              {['Copy & messaging', 'A/B testing', 'Funnel optimalisatie', 'Klantonderzoek & interviews', 'Conversion flows'].map(item => (
                <li key={item} className="flex items-center gap-2">
