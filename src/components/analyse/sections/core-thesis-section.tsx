      ...
      <div className="max-w-7xl mx-auto">
        {coreThesis && (
          <div className="border-l-2 border-accent pl-8 mb-10">
            <p className="font-heading text-[10px] uppercase tracking-[0.18em] text-accent mb-4">The core thesis</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            {biggestTechRisk && (
              <div className="bg-red-50 border border-red-200/60 p-6">
                <p className="font-heading text-[10px] uppercase tracking-[0.15em] text-red-500 mb-2">Biggest technical risk</p>
            ...
            {biggestTechOpportunity && (
              <div className="bg-emerald-50 border border-emerald-200/60 p-6">
                <p className="font-heading text-[10px] uppercase tracking-[0.15em] text-emerald-600 mb-2">Biggest technical opportunity</p>
