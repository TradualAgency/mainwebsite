  ...
  return (
    <section className="bg-primary py-24 px-8">
      <div className="max-w-7xl mx-auto">
        <p className="font-heading text-[10px] uppercase tracking-[0.18em] text-accent mb-4">What should come out</p>
        <h2 className="font-heading text-surface text-[38px] leading-[1.05] md:text-[56px] mb-12">
          Bloat that&apos;s costing you money now.
        </h2>
          ...
          <table className="w-full text-sm min-w-[540px]">
            <thead>
              <tr className="border-b border-surface/10">
                ...
                <th className="text-left py-3 pr-6 font-heading text-[10px] uppercase tracking-[0.15em] text-accent">Reason</th>
                <th className="text-right py-3 pr-4 font-heading text-[10px] uppercase tracking-[0.15em] text-accent">€/mo</th>
                <th className="text-right py-3 font-heading text-[10px] uppercase tracking-[0.15em] text-accent">Perf. gain</th>
              </tr>
            </thead>
            <tbody>
              {bloat.map(b => (
              ...
              {totalSavings > 0 && (
                <tr className="border-t-2 border-accent/40">
                  <td colSpan={3} className="py-3 pr-4 text-surface/50 text-right text-xs uppercase tracking-[0.12em] font-heading">Total savings</td>
        ...
        {migrationApproach && (
          <div className="border-t border-surface/10 pt-10 max-w-3xl">
            <p className="font-heading text-[10px] uppercase tracking-[0.15em] text-accent mb-4">Migration approach</p>
