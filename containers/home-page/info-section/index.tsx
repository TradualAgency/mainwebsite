...
export default function InfoSection() {
    return (
        <section className="info-section my-20 px-8 relative">
            <div className="max-w-7xl mx-auto grid grid-cols-1 gap-8 justify-items-center relative ">
                ...
                <img src="/images/Ellipse%202.png" className="w-[400px] absolute top-[-150px] ml-50 z-0 opacity-50 overflow-x-hidden" alt=""/>
            </div>
        </section>
    )
}