...
export default function HeroSection() {
    return (
        <section className="hero-section px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 gap-8 my-20">
                <h1 className="text-5xl font-interstellar uppercase lg:text-7xl">Uw ideeën transformeren in naadloze digitale ervaringen</h1>
